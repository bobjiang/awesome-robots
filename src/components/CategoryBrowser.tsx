...
export default function CategoryBrowser({
  ...
  useEffect(() => {
    trackCategoryView(categoryName, filteredRobots.length);
  }, [categoryName, filteredRobots.length]);
    ...
    <>
      ...
      <div className="mb-8 flex flex-col lg:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <label htmlFor="category-sort" className="text-sm font-medium text-gray-700">Sort by:</label>
          <select
            id="category-sort"
            value={sortBy}
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-72 flex-shrink-0">
          <FilterSidebar
            ...
            availableCategories={[{ id: categoryId, name: categoryName }]}
          />
        </div>
